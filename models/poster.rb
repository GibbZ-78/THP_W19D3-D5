# poster.rb - Coded with love & sweat by Jean-Baptiste VIDAL for THP Developer curriculum (Winter 2022)
...
class Poster < Item
  ...
  def initialize(poster_id, poster_name, poster_brand = "GibbZ", poster_unit_price = 0.0, poster_quantity = 1, poster_size)
